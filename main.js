...
const I18N = {
  en: {
    ...
    "hero.line1": "Your business processes,",
    "hero.line2": "<em>automated.</em>",
    "hero.sub": "We design and ship AI-powered business process automations that erase repetitive work for small and medium businesses — in weeks, not quarters.",
    ...
    "services.title": "What do we automate?<br>Four areas, zero busywork.",
    "svc1.h": "CRM & sales automation",
    ...
    "svc3.h": "AI customer support & chatbots",
    ...
    "process.title": "From a free automation audit<br>to processes running live.",
    "step1.h": "Audit",
    ...
    "faq.q1": "Do we need coding skills to automate?",
    ...
    "faq.q2": "Which systems does AI automation integrate with?",
    ...
    "faq.q3": "How much does automation cost for an SMB?",
    ...
    "faq.q6": "Make.com, n8n or Zapier — which one should we choose?",
    "faq.a6": "It depends on what you automate: Make.com is the price-performance champion for most SMBs, n8n is the flexible, self-hostable option, and Zapier has the widest integration catalog. In the free audit we'll tell you which fits your processes — we build on all three.",
    ...
    "contact.title": "Request your free<br>automation audit.",
  ...
  hu: {
    ...
    "hero.line1": "Üzleti folyamataid,",
    "hero.line2": "<em>automatizálva.</em>",
    "hero.sub": "Olyan AI-automatizációkat tervezünk és szállítunk, amelyek folyamatautomatizálással tüntetik el az ismétlődő munkát a kis- és középvállalkozásoknál — hetek, nem negyedévek alatt.",
    ...
    "services.title": "Mit automatizálunk?<br>Négy terület, nulla robotmunka.",
    "svc1.h": "CRM- és értékesítés-automatizálás",
    ...
    "svc3.h": "AI-ügyfélszolgálat és chatbot",
    ...
    "svc4.h": "Riportkészítés és dashboardok",
    ...
    "process.title": "Ingyenes automatizálási audittól<br>az élesben futó folyamatokig.",
    "step1.h": "Audit",
    ...
    "faq.q1": "Kell programozási tudás az automatizáláshoz?",
    ...
    "faq.q2": "Milyen rendszerekkel integrálható az AI-automatizáció?",
    ...
    "faq.q3": "Mennyibe kerül az automatizálás egy KKV-nak?",
    ...
    "faq.q6": "Make.com, n8n vagy Zapier — melyiket érdemes választani?",
    "faq.a6": "Attól függ, mit automatizálsz: a Make.com a legtöbb KKV-nak az ár-érték bajnok, az n8n a rugalmas, akár saját szerveren futtatható opció, a Zapier pedig a legszélesebb integrációs kínálat. Az ingyenes auditon megmondjuk, a ti folyamataitokhoz melyik való — mi mindhárommal építünk.",
    ...
    "contact.title": "Kérj ingyenes<br>automatizálási auditot.",
